...
* [Symfony] Persist doctrine.dbal.dms_connection if Doctrine2 module is used #3500. Fixes #3479. By @Naktibalda
...
* [PhpBrowser][Frameworks] added hidden `_request()` method to send requests to dms from Helper classes.
